...
packages <- c('ggplot2', 'dplyr', 'mlbench', 'MASS', 'pROC', 'randomForest', 'tidyverse', 'lsr', 'psych', 'ggthemes', 'tinytex', 'qqPlot', 'sjPlot')
...
Es pot apreciar clarament la diferència de la distribució entre la nostra mostra i la d'una mostra normal.
