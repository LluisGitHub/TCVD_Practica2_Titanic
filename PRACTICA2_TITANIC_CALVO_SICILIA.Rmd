...
```{r echo=TRUE, message=FALSE, warning=FALSE}
contribucio <- c("Investigació prèvia", "Redacció de les respostes", "Desenvolupament codi")
signatures <- c("ASF / LCM", "ASF / LCM", "ASF / LCM")

df_contribucions <- data.frame(contribucio, signatures)

knitr::kable(df_contribucions, col.names = c("Contribució", "Signatures"), caption = 'Contribucions')
```
